/*
   Arduino - Sensore Aldeidi MQ138
*/

#define RL 20  // il valore del resistore RL è 47 kohm
#define m -0.447 // il valore del coefficiente angolare calcolato.
                 // Punti: (x1;y1) e (x2;y2) --> (40;1) e (100;0.8) 
#define b 1.34 // il valore dell'intercetta calcolato.
               // Punto: (x;y) --> (70;0.75)
#define Ro 2.85 // il valore calcolato (con il programma apposito) di Ro
#define MQ_sensor A3 // pin analogico a cui è connesso il sensore
...
void loop() {
  ...
  Serial.print("Concentration aldehydes: ");
  Serial.print(ppm);
  Serial.print(" ppm");
